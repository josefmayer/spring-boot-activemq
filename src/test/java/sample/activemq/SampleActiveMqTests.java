...
public class SampleActiveMqTests {
	...
	public void sendSimpleMessage() throws InterruptedException, JMSException {
		...
		//assertThat(this.outputCapture.toString().equalsIgnoreCase(testmsg)).isTrue();
	...
	@Test
	public void sendSimpleMessage2() throws InterruptedException, JMSException {
		String testmsg = "*** This is the test message 2 ***";
